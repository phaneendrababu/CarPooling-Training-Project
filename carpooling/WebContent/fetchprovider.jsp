...
<body>
			<div class="card">
  				<div class="card-body">
  					<a class="btn btn-primary" href="search.jsp" role="button" style="padding-right: 20px;"><i style="font-size:24px" class="fa">&#xf137;</i><b>BACK</b></a>
 				</div>
				</div>
				<div class="row" style="background-color: #007bff;height: 50px;">
  				...
  				<div class="col"><b class="bb"><i style='font-size:24px' class='fab'>&#xf42c;</i>BOOK</b></div>
				</div>	
			<%
			...
			%>
				...
				<div class="col"><b class="bb"><%=pid%></b></div>
  				...
  				<div class="col"><b class="bb"><%out.print("<a class='btn btn-primary' href='BookConfirm?pid=" + pid + "' role='button' style='padding-right: 20px;'><b>BOOK NOW</b></a>");%></b></div>
				</div>

	...
	<main style="height:600px;">
		<div class="main-div">
			...
			try
			{
	            ...
	            PreparedStatement ps=con.prepareStatement("SELECT * FROM V_HISTORY WHERE p_id=? order by time DESC");
	            ps.setInt(1,eid);
			...
			<div class="card">
  				<div class="card-body">
  				<span><p><i style="font-size:30px;color:red;" class="fa">&#xf1da;</i>YOUR PREVIOUS REQUESTS</p></span>
 			</div>
 			<%
 			while(rs.next())
 			{%>
